...
exports.resetVersionamento = exports.gerarVersionamento = void 0;
var http_client_1 = __nccwpck_require__(4367);
function gerarVersionamento(request) {
    return __awaiter(this, void 0, void 0, function () {
        var code, namePackage, httpClient, response, version;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    code = "code=" + request.code;
                    namePackage = "namePackage=" + request.namePackage;
                    httpClient = new http_client_1.HttpClient();
                    return [4 /*yield*/, httpClient.get("https://tlv7-versionamento.azurewebsites.net/api/GerarVersionamento?" + code + "&" + namePackage, {
                            "accountEndpoint": request.accountEndpoint,
                            "token": request.token
                        })];
                case 1:
                    response = _a.sent();
                    if (!(response.message.statusCode == 200)) return [3 /*break*/, 3];
...
exports.gerarVersionamento = gerarVersionamento;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    namePackage = "namePackage=" + request.namePackage;
                    httpClient = new http_client_1.HttpClient();
                    return [4 /*yield*/, httpClient.post("https://tlv7-versionamento.azurewebsites.net/api/ResetVersionamento?" + code + "&" + namePackage, JSON.stringify({ numeroVersao: request.numeroVersao }), {
                            "accountEndpoint": request.accountEndpoint,
                            "token": request.token
                        })];
                case 1:
...
gerarVersionamento({
    ...
    code: "rsUNK1-yfZPqPJvyfOwKqDozAV0hTmkpIdQjkufSxSfbAzFu__ujLA",
    namePackage: "GitFlow.Eleicoes",
    numeroVersao: 0,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const versionamento_1 = __nccwpck_require__(3898);
const contexto_1 = __nccwpck_require__(5517);
const core = __importStar(__nccwpck_require__(2186));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const inputs = (0, contexto_1.getInputsGerarVersionamento)();
            yield (0, versionamento_1.gerarVersionamento)(inputs.requestVersionamento)
                .then((res) => {
                var _a;
